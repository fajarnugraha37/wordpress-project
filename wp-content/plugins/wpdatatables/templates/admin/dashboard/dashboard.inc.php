                ...
                <div class="card wdt-changelog-card">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <p class="wpdt-text wpdt-font m-b-18">
                            A minor update with some bug fixes and improvements:
                        </p>
                        <div class="alert alert-info m-b-0" role="alert">
                            <i class="wpdt-icon-info-circle-full"></i>
                            <ul>
                                <li><strong>Improvement:</strong> Updated back-end images.</li>
                                <li><strong>BugFix:</strong> Added wpdatatables_curl_get_data and wpdatatables_curl_get_data_complete filters.</li>
                                <li><strong>BugFix:</strong> Added dynamic table title id based on table ID.</li>
                                <li><strong>BugFix:</strong> Resolved security issue with XSS (discovered by Rafshanzani Suhada).</li>
